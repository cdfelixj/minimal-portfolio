...
export default function AboutMe() {
  return (
    ...
    <div className='flex flex-col md:flex-row m gap-10'>
    <p className="flex">A little about my background - I'm of Chinese-Indonesian ethnicity and went to Rosaryhill Secondary School here in Hong Kong. My Cantonese isn't the greatest but my English is native.
