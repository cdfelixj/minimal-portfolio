  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: 'Python', level: 90, icon: '/assets/skills/python-127-svgrepo-com.svg' },
        { name: 'Java', level: 85, icon: '/assets/skills/java.svg' },
        { name: 'C#', level: 80, icon: '/assets/skills/695px-C_Programming_Language.svg.png' },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'NLTK/Gensim', level: 75 },
        { name: 'RAG Pipelines', level: 85 },
        { name: 'Financial NLP', level: 80 },
      ],
    },
    {
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'R/RStudio', level: 70, icon: '/assets/skills/r-lang.svg' },
