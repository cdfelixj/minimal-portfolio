export default [
    {
     ...
     {
         year: '2023',
         title: "BSc(Hons) Business Computing & Data Analytics",
         duration: '',
         details:
             'I started my degree in HKBU where I learnt the knowledge of Object Oriented Programming, Data Structures & Algorithms and met peers who are pursuing the same path.',
     },
     {
        year: '2022 Summer',
