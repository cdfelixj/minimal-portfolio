export default [
    ...
    },
    {
        ...
        duration: 'HKBU',
        details:
            "Been a part of Dr Kim Yoon Ho's research on the efficacy of using AI to read Financial Statements. Developed ML models achieving 95% accuracy in financial document classification.",
    },
    {
        ...
        duration: 'Wizpresso',
        details:
            'Built full-stack solutions for e-commerce platform optimization. Developed responsive applications using React and Node.js, integrated payment systems, and optimized database performance by 40%.',
    },
    {
        year: 'Jul 2025 – Aug 2025',
        title: 'Digital & IT Intern',
        duration: 'Cathay Pacific',
        details:
            'Enhanced digital transformation initiatives across multiple departments. Developed automated reporting dashboards and collaborated with cross-functional teams on IT infrastructure optimization.',
    },
]